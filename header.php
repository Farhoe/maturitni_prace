...
<head>
  ...
  <link href="vendor/components/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    ...
    <div class="sidebar-brand-text mx-3" href="index.php">Customer Relationship Management</div>
  </a>
